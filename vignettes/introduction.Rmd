...
Setting `strict = TRUE` ensures that at least one tip has the maximum
character state defined by `k`. This is useful when you want to guarantee
...
convergent traits, and summarises the tree structure.
